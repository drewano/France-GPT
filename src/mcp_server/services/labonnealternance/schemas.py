...
class Adresse(BaseModel):
    ...
    commune: Optional[dict] = Field(
        default=None, description="Informations sur la commune."
    )
    departement: Optional[dict] = Field(
        default=None, description="Informations sur le département."
    )
    region: Optional[dict] = Field(
        default=None, description="Informations sur la région."
    )
    academie: Optional[dict] = Field(
        default=None, description="Informations sur l'académie."
    )
...
class JobIdentifier(BaseModel):
    ...
    partner_job_id: str = Field(
        description="Identifiant de l'offre dans le système d'information du partenaire."
    )
    id: Optional[str] = Field(
        default=None,
        description="Identifiant de l'offre d'emploi dans la base de données La bonne alternance.",
    )
    partner_label: str = Field(
        description="Partenaire à l'origine de l'offre d'emploi."
    )
...
class JobWorkplaceDomain(BaseModel):
    ...
    idcc: Optional[Union[int, None]] = Field(
        default=None, description="Numéro de convention collective associé au SIRET."
    )
    opco: Optional[Union[str, None]] = Field(
        default=None, description="Opérateur de Compétences (OPCO) associé au SIRET."
    )
    naf: Optional[Union[dict, None]] = Field(
        default=None, description="Code NAF (secteur d'activité) associé au SIRET."
    )
...
class JobWorkplace(BaseModel):
    ...
    name: Optional[Union[str, None]] = Field(
        default=None,
        description="Nom de l'établissement (enseigne ou, à défaut, nom légal).",
    )
    description: Optional[Union[str, None]] = Field(
        default=None,
        description="Description de l'employeur et/ou du département où sera exécuté le contrat.",
    )
    website: Optional[Union[str, None]] = Field(
        default=None, description="Site web de l'entreprise."
    )
    siret: Optional[Union[str, None]] = Field(
        default=None, description="SIRET du lieu d'exécution du contrat."
    )
    location: Optional[dict] = Field(
        default=None,
        description="Adresse postale et géolocalisation rattachées au numéro SIRET de l'entreprise.",
    )
    brand: Optional[Union[str, None]] = Field(
        default=None, description="Enseigne de l'établissement."
    )
    legal_name: Optional[Union[str, None]] = Field(
        default=None, description="Raison sociale de l'entreprise."
    )
    size: Optional[Union[str, None]] = Field(
        default=None, description="Effectif de l'entreprise, en nombre d'employés."
    )
    domain: Optional[JobWorkplaceDomain] = Field(
        default=None, description="Domaine d'activité du lieu de travail."
    )
...
class JobApply(BaseModel):
    ...
    phone: Optional[Union[str, None]] = Field(
        default=None, description="Numéro de téléphone du recruteur."
    )
    url: str = Field(
        description="URL de redirection vers le formulaire de candidature."
    )
    recipient_id: Optional[Union[str, None]] = Field(
        default=None,
        description="Identifiant à utiliser pour postuler à l'offre d'emploi.",
    )
...
class JobContract(BaseModel):
    ...
    start: Optional[Union[str, None]] = Field(
        default=None, description="Date de début du contrat."
    )
    duration: Optional[Union[int, None]] = Field(
        default=None, description="Durée du contrat en mois."
    )
    type: List[str] = Field(
        description="Type de contrat (apprentissage et/ou professionnalisation)."
    )
    remote: Optional[Union[str, None]] = Field(
        default=None, description="Mode de travail (sur site, à distance ou hybride)."
    )
...
class JobOffer(BaseModel):
    ...
    desired_skills: List[str] = Field(
        description="Les compétences ou qualités attendues pour le poste."
    )
    to_be_acquired_skills: List[str] = Field(
        description="Les compétences ou qualités à acquérir durant l'apprentissage."
    )
    access_conditions: List[str] = Field(
        description="Les conditions d'accès au métier."
    )
    opening_count: Union[int, float] = Field(
        description="Nombre de postes disponibles pour cette offre d'emploi."
    )
    publication: Optional[dict] = Field(
        default=None, description="Informations de publication de l'offre."
    )
    ...
    target_diploma: Optional[Union[dict, None]] = Field(
        default=None, description="Diplôme visé à l'issue des études."
    )
...
class FormationIdentifiant(BaseModel):
    ...
    cle_ministere_educatif: str = Field(
        description="Identifiant unique de la formation sur le catalogue des formations en apprentissage."
    )
...
class OrganismeIdentifiant(BaseModel):
    ...
    uai: Optional[Union[str, None]] = Field(
        default=None, description="Numéro UAI de l'organisme."
    )
...
class OrganismeEtablissement(BaseModel):
    ...
    enseigne: Optional[Union[str, None]] = Field(
        default=None, description="Enseigne de l'établissement."
    )
    adresse: Optional[Union[Adresse, None]] = Field(
        default=None, description="Adresse de l'établissement."
    )
    geopoint: Optional[Union[GeoJsonPoint, None]] = Field(
        default=None, description="Coordonnées GPS de l'établissement."
    )
    creation: datetime = Field(description="Date de création de l'établissement.")
    fermeture: Optional[Union[datetime, None]] = Field(
        default=None, description="Date de fermeture de l'établissement."
    )
...
class OrganismeUniteLegale(BaseModel):
    ...
    cessation: Optional[Union[datetime, None]] = Field(
        default=None, description="Date de cessation de l'unité légale."
    )
...
class OrganismeRenseignementsSpecifiques(BaseModel):
    ...
    numero_activite: Optional[Union[str, None]] = Field(
        default=None, description="Numéro d'activité."
    )
...
class OrganismeStatut(BaseModel):
    ...
    referentiel: str = Field(
        description="Statut de l'organisme dans le référentiel des organismes en apprentissage."
    )
...
class Organisme(BaseModel):
    ...
    etablissement: OrganismeEtablissement = Field(
        description="Établissement de l'organisme."
    )
    unite_legale: OrganismeUniteLegale = Field(
        description="Unité légale de l'organisme."
    )
    renseignements_specifiques: OrganismeRenseignementsSpecifiques = Field(
        description="Renseignements spécifiques."
    )
...
class CertificationIdentifiant(BaseModel):
    ...
    cfd: Optional[Union[str, None]] = Field(
        default=None, description="Code Formation Diplôme (CFD) de la certification."
    )
    rncp: Optional[Union[str, None]] = Field(
        default=None,
        description="Code Répertoire National des Certifications Professionnelles (RNCP) de la certification.",
    )
    rncp_anterieur_2019: Optional[Union[bool, None]] = Field(
        default=None,
...
class Certification(BaseModel):
    ...
    identifiant: CertificationIdentifiant = Field(
        description="Identifiants de la certification."
    )
    intitule: CertificationIntitule = Field(description="Intitulé de la certification.")
    base_legale: Optional[dict] = Field(
        default=None,
        description="Dates de création et d'abrogation des diplômes crées par arrêtés.",
    )
    blocs_competences: Optional[dict] = Field(
        default=None,
        description="Liste du (ou des) code (s) et intitulé(s) des blocs de compétences validés par la certification.",
    )
    convention_collectives: Optional[dict] = Field(
        default=None,
        description="Liste(s) de la ou des convention(s) collective(s) rattachées à la certification.",
    )
    domaines: Optional[dict] = Field(
        default=None, description="Domaines de la certification."
    )
    periode_validite: Optional[dict] = Field(
        default=None, description="Période de validité de la certification."
    )
    type: Optional[dict] = Field(default=None, description="Type de certification.")
    continuite: Optional[dict] = Field(
        default=None,
        description="Liste des couples CFD-RNCP assurant la continuité de la certification professionnelle.",
    )
...
class FormationFormateur(BaseModel):
    ...
    organisme: Optional[Union[Organisme, None]] = Field(
        default=None, description="L'organisme de formation."
    )
...
class FormationResponsable(BaseModel):
    ...
    organisme: Optional[Union[Organisme, None]] = Field(
        default=None, description="L'organisme responsable."
    )
...
class FormationLieu(BaseModel):
    ...
    geolocalisation: GeoJsonPoint = Field(
        description="Géolocalisation du lieu de formation."
    )
    precision: Optional[Union[float, None]] = Field(
        default=None,
        description="Précision de la géolocalisation du lieu de formation en mètres.",
    )
    siret: Optional[Union[str, None]] = Field(
        default=None, description="Numéro SIRET du lieu de formation."
    )
    uai: Optional[Union[str, None]] = Field(
        default=None, description="Numéro UAI du lieu de formation."
    )
...
class FormationContact(BaseModel):
    ...
    email: Optional[Union[str, None]] = Field(
        default=None, description="Email de contact de la formation."
    )
    telephone: Optional[Union[str, None]] = Field(
        default=None, description="Téléphone de contact de la formation."
    )
...
class FormationModalite(BaseModel):
    ...
    entierement_a_distance: bool = Field(
        description="Indique si la formation est entièrement à distance."
    )
    duree_indicative: Union[int, float] = Field(
        description="Durée indicative de la formation."
    )
    annee_cycle: Optional[Union[int, None]] = Field(
        default=None, description="L'année de démarrage de la session de formation."
    )
    mef_10: Optional[Union[str, None]] = Field(
        default=None, description="Code MEF 10 de la formation."
    )
...
class FormationSession(BaseModel):
    ...
    capacite: Optional[Union[Union[int, float], None]] = Field(
        default=None, description="Capacité de la session."
    )
...
class Formation(BaseModel):
    ...
    identifiant: FormationIdentifiant = Field(
    ...
    responsable: FormationResponsable = Field(
        description="Responsable de la formation."
    )
    certification: FormationCertification = Field(
        description="Certification de la formation."
    )
    lieu: FormationLieu = Field(description="Lieu où la formation est dispensée.")
    contact: FormationContact = Field(
        description="Coordonnées à utiliser pour contacter l'organisme."
    )
    onisep: FormationOnisep = Field(
        description="Informations lié à la formation issues de l'ONISEP."
    )
    modalite: FormationModalite = Field(description="Modalité de la formation.")
    contenu_educatif: FormationContenuEducatif = Field(
        description="Contenu éducatif de la formation."
    )
    sessions: List[FormationSession] = Field(
...
class FormationDetails(FormationSummary):
    ...
    educational_content: Optional[str] = Field(
        default=None, description="Contenu pédagogique de la formation."
    )
    objective: Optional[str] = Field(
        default=None, description="Objectifs de la formation."
    )
    sessions: Optional[List[dict]] = Field(
        default=None, description="Liste des sessions de la formation."
    )
...
class RncpCode(BaseModel):
    ...
    code_rncp: str = Field(
        alias="Code RNCP", description="Le code RNCP de la certification."
    )
    intitule: str = Field(
        alias="Intitulé de la certification",
        description="L'intitulé complet de la certification.",
    )
    certificateur: Optional[Union[str, int]] = Field(
        alias="Certificateur", description="L'organisme certificateur."
    )
    type_diplome: Optional[str] = Field(
        alias="Type diplôme",
        description="Le type de diplôme (ex: BP, Titre professionnel).",
    )
