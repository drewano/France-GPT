...
def discover_and_customize(
    ...
    """
    Fonction de compatibilité pour la fonction discover_and_customize.

    Cette fonction est conservée pour la compatibilité avec le code existant
    mais délègue vers la méthode de la classe ToolTransformer.
    """
    # Appel de la fonction de personnalisation existante
...
async def transform_and_register_tools(
    ...
    """
    Fonction de compatibilité pour transform_and_register_tools.

    Cette fonction est conservée pour la compatibilité avec le code existant
    mais délègue vers la classe ToolTransformer.
    """
    ...
    await transformer.transform_tools()
